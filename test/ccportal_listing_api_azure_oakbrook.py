...
yesterday = (datetime.now().date() - timedelta(days=0)).strftime("%d/%m/%Y")  # Keep 1 Day before date ie day=1
today_date = (datetime.now(pytz.timezone('Asia/Kolkata')) - timedelta(days=1)).strftime(
...
def test_listing_total_count():
    ...
    access_token="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6IkwxS2ZLRklfam5YYndXYzIyeFp4dzFzVUhIMCIsImtpZCI6IkwxS2ZLRklfam5YYndXYzIyeFp4dzFzVUhIMCJ9..ibTnHH6ROffLIKozYwmJeS_0YijI2h7Hn6PNM7dEgnIivQsiAcZdPnX_RH2H_s-3GnzRg24mCRNyOgxu-_5MF9bVBgAV2FPc1ZnG8XxPERNOGzFHWNKaS-Bk7mE4-6q_QZSUUTiWmYb8t7_SYpjV60GilpLrPKU1V6uPRS5TuAzulfvHNmAKlVHLI5IaOz2Nng1TtSM_OgNqqGwyV8GeHGDkhc493sk00ln6CwxUIptHhRhi1bLqhgIOkOYhWxLg6FnSNguMg3y8tLBkIS81i_veqk_Ip7QawGn95Nc_4OXqr8vs_e0gXRI6YhpYkOcyYY0C40aIHzIP6h41c2v2IQ"
    global page_no
    url = gurl
    payload = {}
    headers = {
